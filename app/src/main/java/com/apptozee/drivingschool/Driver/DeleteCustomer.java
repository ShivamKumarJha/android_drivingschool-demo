...
public class DeleteCustomer extends AppCompatActivity {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(e2.getText().toString())){
                    ...
                    DBHome dbh = new DBHome(DeleteCustomer.this);
                    boolean res = dbh.verification(e2.getText().toString());
                    if (res) {
                        dbh.deleteData(e2.getText().toString());
                        dbh.close();
                        ...
                        //Snackbar to let driver know customer details are deleted
                        Snackbar snackbar = Snackbar
                                .make(v, "DELETED.", Snackbar.LENGTH_INDEFINITE)
    ...
    public void onBackPressed() {
        Intent i = new Intent(DeleteCustomer.this,DriverActivity.class);
        startActivity(i);
